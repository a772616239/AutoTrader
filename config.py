...
# 预设一些需要使用 a9 策略的标的（可按需修改）。仅在用户未显式设置时应用。
preselect_a2 = {
    # a8 动量反转策略 - 基于早盘动量/午盘反转信号
    'AMD':  'a8',
    'META': 'a8',
    'RIVN': 'a8',
    'COIN': 'a8',
    ...
    'ZM':   'a8',
    'UBER': 'a8',
    'UPST': 'a8',  # 新增 - 高波动金融科技，适合动量反转
    'DUOL': 'a8',  # 新增 - 高波动成长股
    'AUDC': 'a8',  # 新增 - 小盘科技股，情绪驱动
    'TMDX': 'a8',  # 新增 - 医疗设备股，高波动

    # a9 Z-Score均值回归策略 - 基于统计套利
    'XOM':  'a9',
    'CVX':  'a9',
    'JPM':  'a9',
    'PFE':  'a9',
    ...
    'BAC':  'a9',
    'GS':   'a9',
    'PEP':  'a9',  # 新增 - 稳定消费品，均值回归强
    'CSCO': 'a9',  # 新增 - 成熟科技股，稳定波动
    'TXN':  'a9',  # 新增 - 半导体周期股，均值回归明显
    'COMM': 'a9',  # 新增 - 通信设备，周期性
    'UNH':  'a9',  # 新增 - 医疗巨头，稳定大盘股
    'DINO': 'a9',  # 新增 - 炼油股，周期性均值回归

    # a10 双均线成交量突破策略 - 基于趋势突破
    'TEAM': 'a10',
    'GOOGL': 'a10',
    'CRM':  'a10',
    'ORCL': 'a10',
    ...
    'IBM':  'a10',
    'NOW':  'a10',
    'AAPL': 'a10',  # 新增 - 趋势清晰，成交量稳定
    'ADP':  'a10',  # 新增 - 企业服务，稳定趋势
    'DV':   'a10',  # 新增 - 数字验证，成长趋势明确
    ...
    'NKE':  'a11',
    'SBUX': 'a11',
    'BABA': 'a11',  # 新增 - 中概股，经常深度回调
    'BIDU': 'a11',  # 新增 - 类似BABA，回调幅度大
    'LAC':  'a11',  # 新增 - 锂矿股，波动大，回调频繁

    # a12 多因子AI融合策略 - 整合流动性、基本面、情绪、动量
    'NVDA': 'a12',
    'MSFT': 'a12',
    'ETN':  'a12',
    'SNOW': 'a12',
    ...
    # a13 新闻交易策略 - 基于实时新闻情绪分析
    'ALHC': 'a13',  # 新增 - 医疗保健，政策敏感
    'CLSK': 'a13',  # 新增 - 比特币挖矿，加密货币新闻驱动
    'TSSI': 'a13',  # 新增 - 小盘科技，事件驱动
    'SMR':  'a13',  # 新增 - 核能概念，政策新闻敏感
    'SLDP': 'a13',  # 新增 - 固态电池，新闻事件驱动

    # a14 CTA趋势跟踪策略 - 基于唐奇安通道突破
    'SMCI': 'a14',
    'TSM':  'a14',
    'BA':   'a14',
    'ASML': 'a14',
    ...
    'RTX':  'a14',
    'AMAT': 'a14',
    'AZN':  'a14',  # 新增 - 大型药企，趋势稳定
    'STX':  'a14',  # 新增 - 存储周期股，趋势明显
    'WDC':  'a14',  # 新增 - 同存储行业，趋势性强
}
